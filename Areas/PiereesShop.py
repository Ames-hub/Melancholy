...
if visitedshop == 0 and trauma > 60:
    time.sleep(1)
...
if visitedshop == 0 and trauma < 60:
    ...
    print("[!] New option Available! Confide in Pierre")
    logging.info("New option available! Confide in Pierre")
    therpiereest = 1
    # Inserts into the table "Special"
    cur.execute("INSERT INTO Special VALUES(?)", (therpiereest))
    logging.info ("PiereesShop.py has inserted thepiereest into the Special table")
    if debug == True:
...
if visitedshop == 1 and trauma > 60:
    print("Welcome back!")
    time.sleep(1)
    print(randgreet())
    time.sleep(3)
...
if therpiereest == True:
    print("4. Confide in pieree")
