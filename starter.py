...
cur.execute('''CREATE TABLE IF NOT EXISTS Stats (health integer RIMARYKEY, maxhealth integer, stamina integer, maxstamina integer, money integer, trauma)''')
...
cur.execute("INSERT INTO Stats VALUES (?, ?, ?, ?, ?, ?)", (health, maxhealth, stamina, maxstamina, money, trauma))
